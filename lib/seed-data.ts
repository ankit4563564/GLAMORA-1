...
export const SEED_SALONS = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 289,
    specialty: "Non-Surgical Cosmetic Treatments",
    description:
      "Indiranagar's premier aesthetics clinic offering Botox, fillers, and advanced skin rejuvenation treatments.",
    services: [
      { name: "Anti-Wrinkle Botox", price: 8500, duration: 45, category: "Aesthetics" },
      { name: "Dermal Filler Lips", price: 12000, duration: 60, category: "Aesthetics" },
      { name: "Chemical Peel Advanced", price: 4500, duration: 60, category: "Skin" },
      { name: "Skin Booster Treatment", price: 9500, duration: 75, category: "Aesthetics" },
    ],
    images: [
      unsplash("photo-1570172619644-d3b9eb3b0b0b"),
      unsplash("photo-1616394584738-fc6e612f888b"),
    ...
    tags: ["aesthetics", "skin-clinic", "luxury"],
    sentimentSummary: {
      overall: "Highly Positive",
      score: 0.94,
      topKeywords: ["Natural Results", "Expert Doctor", "Safe Procedures"],
      topBookedService: "Anti-Wrinkle Botox",
      peakHours: [
        { hour: "11", bookings: 22 },
        { hour: "14", bookings: 38 },
        { hour: "17", bookings: 32 },
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 245,
    specialty: "Organic Beauty & Wellness",
    description:
      "Koramangala's eco-friendly beauty haven using organic products for sustainable self-care rituals.",
    services: [
      { name: "Organic Facial", price: 2800, duration: 75, category: "Skin" },
      { name: "Henna Art Premium", price: 1500, duration: 60, category: "Bridal" },
      { name: "Natural Hair Spa", price: 2200, duration: 60, category: "Hair" },
      { name: "Aromatherapy Massage", price: 3500, duration: 90, category: "Spa" },
    ],
    images: [
      unsplash("photo-1519741497674-611481863552"),
      unsplash("photo-1487412948497-84dc97e43b0b"),
    ...
    tags: ["organic", "spa", "skin-clinic"],
    sentimentSummary: {
      overall: "Positive",
      score: 0.87,
      topKeywords: ["Natural Products", "Relaxing", "Eco-Friendly"],
      topBookedService: "Organic Facial",
      peakHours: [
        { hour: "10", bookings: 18 },
        { hour: "15", bookings: 35 },
        { hour: "18", bookings: 28 },
    ...
    ownerEmail: "anjali@blushbloom.in",
    coordinates: { lat: 12.9352, lng: 77.6245 },
  },
  {
    name: "Elite Men's Lounge",
    area: "Whitefield",
    city: "Bangalore",
    rating: 4.8,
    reviewCount: 312,
    specialty: "Premium Men's Grooming",
    description:
      "Whitefield's exclusive men's grooming destination with luxury services and premium products.",
    services: [
      { name: "Executive Haircut", price: 1800, duration: 45, category: "Men's" },
      { name: "Beard Design & Trim", price: 1200, duration: 30, category: "Men's" },
      { name: "Hot Towel Shave", price: 1000, duration: 30, category: "Men's" },
      { name: "Men's Facial", price: 2500, duration: 60, category: "Skin" },
    ],
    images: [
      unsplash("photo-1503951914875-452162b0f3f1"),
      unsplash("photo-1622286342621-4bd786c2447c"),
    ...
    tags: ["mens", "premium-grooming", "luxury"],
    sentimentSummary: {
      overall: "Highly Positive",
      score: 0.92,
      topKeywords: ["Premium Service", "Professional", "Luxury Experience"],
      topBookedService: "Executive Haircut",
      peakHours: [
        { hour: "11", bookings: 25 },
        { hour: "14", bookings: 40 },
        { hour: "18", bookings: 35 },
    ...
    ownerEmail: "vikram@elitemens.in",
  ...
  },
  {
    ...
    rating: 4.5,
    reviewCount: 198,
    specialty: "Quick Beauty Services",
    description:
      "HSR Layout's express beauty bar for quick touch-ups, blowouts, and express treatments.",
    services: [
      { name: "Express Blowout", price: 1200, duration: 30, category: "Hair" },
      { name: "Quick Makeup", price: 1500, duration: 30, category: "Bridal" },
      { name: "Express Facial", price: 1800, duration: 45, category: "Skin" },
      { name: "Nail Art Express", price: 800, duration: 30, category: "Aesthetics" },
    ],
    images: [
      unsplash("photo-1521590832167-7bcbfaa6381f"),
      unsplash("photo-1633681923016-1962d3648a3a"),
    ...
    tags: ["hair", "aesthetics", "premium-grooming"],
    sentimentSummary: {
      overall: "Positive",
      score: 0.84,
      topKeywords: ["Quick Service", "Convenient", "Good Results"],
      topBookedService: "Express Blowout",
      peakHours: [
        { hour: "12", bookings: 32 },
        { hour: "17", bookings: 45 },
        { hour: "19", bookings: 28 },
  ...
  },
  {
    ...
    description:
      "Jayanagar's sanctuary for healing massages, reflexology, and stress-relief therapies.",
    services: [
      { name: "Aromatherapy Massage", price: 3800, duration: 90, category: "Spa" },
      { name: "Reflexology Session", price: 2500, duration: 60, category: "Spa" },
      { name: "Hot Stone Therapy", price: 4200, duration: 90, category: "Spa" },
      { name: "Stress Relief Package", price: 6500, duration: 120, category: "Spa" },
    ],
    images: [
      unsplash("photo-1540555700478-4be289fbecef"),
      unsplash("photo-1544161515-4ab6ce6db874"),
    ...
    sentimentSummary: {
      overall: "Highly Positive",
      score: 0.95,
      topKeywords: ["Healing", "Expert Therapists", "Peaceful"],
      topBookedService: "Aromatherapy Massage",
      peakHours: [
        { hour: "10", bookings: 22 },
        { hour: "14", bookings: 38 },
        { hour: "17", bookings: 42 },
    ...
    ownerName: "Dr. Meera Krishnan",
    ownerEmail: "meera@tranquiltouch.in",
    coordinates: { lat: 12.9304, lng: 77.5801 },
  },
];
